...
class PricingDayRbacFeature extends PricingDayBaseFeature
{
    ...
    private function _required(PricingDayContext $ctx): ?string
    {
    ...
    private function _reject(PricingDayContext $ctx, string $required): void
    {
    ...
    private function _track(PricingDayContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
