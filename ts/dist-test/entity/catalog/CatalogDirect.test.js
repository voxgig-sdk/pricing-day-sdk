...
(0, node_test_1.describe)('CatalogDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PricingDaySDK({
    ...
    (0, node_test_1.test)('direct-load-catalog', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-catalog', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PRICING_DAY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PricingDaySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PRICING_DAY_TEST_CATALOG_ENTID'];
    ...
    const client = new __1.PricingDaySDK({
        base: 'http://localhost:8080',
