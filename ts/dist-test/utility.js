...
function envOverride(m) {
    if ('TRUE' === process.env.PRICING_DAY_TEST_LIVE ||
        'TRUE' === process.env.PRICING_DAY_TEST_OVERRIDE) {
    ...
    m.PRICING_DAY_TEST_EXPLAIN = process.env.PRICING_DAY_TEST_EXPLAIN || m.PRICING_DAY_TEST_EXPLAIN;
    return m;
}
