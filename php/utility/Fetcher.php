...
// PricingDay SDK utility: fetcher

class PricingDayFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PricingDaySDK/1.0)';
    ...
    public static function call(PricingDayContext $ctx, string $fullurl, array $fetchdef): array
    {
