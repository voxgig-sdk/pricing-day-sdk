...
// PricingDay SDK utility: graphql
//
...
class PricingDayGraphql
{
    ...
    // equivalent.
    public static function body(PricingDayContext $ctx): mixed
    {
    ...
    public static function errors(PricingDayContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
