...
// PricingDay SDK telemetry feature
...
class PricingDayTelemetryFeature extends PricingDayBaseFeature
{
    ...
    private function _close(PricingDayContext $ctx, bool $ok): void
    {
