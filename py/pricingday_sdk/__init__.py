...
from pricingday_sdk.utility import register

# Load features
from pricingday_sdk.feature.base_feature import PricingDayBaseFeature
from pricingday_sdk.features import _has_feature, _make_feature
...
class PricingDaySDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PricingDayUtility()
        self._utility = utility

        from pricingday_sdk.config import shared_config
    ...
    def get_utility(self):
        return PricingDayUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PricingDaySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Catalog(self, data=None) -> "CatalogEntity":
        ...
        from pricingday_sdk.entity.catalog_entity import CatalogEntity
        return CatalogEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "PricingDaySDK":
        if sdkopts is None:
            sdkopts = {}
