...
class CatalogEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set PRICING_DAY_TEST_CATALOG_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def catalog_basic_setup(extra)
  ...
  entid_env_raw = ENV["PRICING_DAY_TEST_CATALOG_ENTID"]
