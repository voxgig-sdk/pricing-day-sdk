...
class PricingDayTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PricingDayTestRunner.getenv("PRICINGDAY_TEST_LIVE")
        override = PricingDayTestRunner.getenv("PRICINGDAY_TEST_OVERRIDE")
        ...
        explain = PricingDayTestRunner.getenv("PRICINGDAY_TEST_EXPLAIN")
