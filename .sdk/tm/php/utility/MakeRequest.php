...
// PricingDay SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PricingDayMakeRequest
{
    public static function call(PricingDayContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PricingDayResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PricingDayResponse($fetched);
        } else {
