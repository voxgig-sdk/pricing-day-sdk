...
// PricingDay SDK ratelimit feature
...
class PricingDayRatelimitFeature extends PricingDayBaseFeature
{
    ...
    private function _acquire(PricingDayContext $ctx): void
    {
    ...
    private function _track(PricingDayContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
