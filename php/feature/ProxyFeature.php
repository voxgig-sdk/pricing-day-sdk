...
class PricingDayProxyFeature extends PricingDayBaseFeature
{
    ...
    public function init(PricingDayContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PricingDayContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
