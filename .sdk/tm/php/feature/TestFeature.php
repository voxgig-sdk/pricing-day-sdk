...
// PricingDay SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PricingDayTestFeature extends PricingDayBaseFeature
{
    ...
    public function init(PricingDayContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PricingDayContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PricingDayParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PricingDayContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PricingDayContext $ctx, $op, $args): array
    {
