...
func registerSDKWords(r *eng.Registry, client *sdk.PricingDaySDK) {
...
func runOp(client *sdk.PricingDaySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
