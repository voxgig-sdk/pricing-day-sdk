...
// PricingDay SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PricingDaySDK::test)
...
{
    private const SDK_CLASS = 'PricingDaySDK';
    ...
    private const SDK_BASE = 'pricingday_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../pricingday_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
