// Command PricingDay-mcp is an MCP server exposing the PricingDay
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PricingDay_list  — list records of an entity
//	PricingDay_load  — load a single record of an entity
//
