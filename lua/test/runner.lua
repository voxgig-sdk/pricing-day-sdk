...
function runner.env_override(m)
  local live = runner.getenv("PRICING_DAY_TEST_LIVE")
  local override = runner.getenv("PRICING_DAY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PRICING_DAY_TEST_EXPLAIN")
