...
class PricingDayNetsimFeature extends PricingDayBaseFeature
{
    ...
    private function _simulate(PricingDayContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PricingDayContext $ctx, array $applied): void
    {
        $client = $this->client;
