...
// PricingDay SDK timeout feature
...
class PricingDayTimeoutFeature extends PricingDayBaseFeature
{
    ...
    private function _with_timeout(PricingDayContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PricingDayContext $_ctx, float $ms): void
    {
        $client = $this->client;
