...
|---|---|---|
| `ts/` | @voxgig-sdk/pricing-day-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/pricing-day-sdk \
      --repository voxgig-sdk/pricing-day-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/pricing-day-sdk` shows it, and
`npm trust revoke @voxgig-sdk/pricing-day-sdk --id=<id>` removes it.
