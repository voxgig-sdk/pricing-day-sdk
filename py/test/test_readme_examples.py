# PricingDay SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PricingDaySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PricingDaySDK(...) and PricingDaySDK.test(...) become
#      PricingDaySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pricingday_sdk"
_SDK_CLASS = "PricingDaySDK"
