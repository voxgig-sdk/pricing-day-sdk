...
type Args struct {
	Entity string         `json:"entity" jsonschema:"catalog"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PricingDaySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "pricing-day_list",
		Description: "List records from PricingDay. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "pricing-day_load",
		Description: "Load a single record from PricingDay. " +
...
func runOp(client *sdk.PricingDaySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PricingDaySDK, name string) (sdk.PricingDayEntity, error) {
