...
// PricingDay SDK streaming feature
...
class PricingDayStreamingFeature extends PricingDayBaseFeature
{
    ...
    private function _iterate(PricingDayResult $result): \Generator
    {
    ...
    private function _streamable(PricingDayContext $ctx): bool
    {
