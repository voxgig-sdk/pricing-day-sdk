...
describe("CatalogDirect", function()
  it("should direct-load-catalog", function()
    local setup = catalog_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-catalog", setup.live and "live" or "unit")
