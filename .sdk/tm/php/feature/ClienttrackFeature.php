...
// PricingDay SDK clienttrack feature
...
class PricingDayClienttrackFeature extends PricingDayBaseFeature
{
    ...
    public function PostConstruct(PricingDayContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PricingDay-SDK';
