...
class PricingDayCacheFeature extends PricingDayBaseFeature
{
    ...
    private function _through(PricingDayContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
