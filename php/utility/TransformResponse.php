...
// PricingDay SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PricingDayTransformResponse
{
    public static function call(PricingDayContext $ctx): mixed
    {
        ...
        $transform = PricingDayHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
